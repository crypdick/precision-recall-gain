...
precision-recall-gain could always use more documentation, whether as part of the
official precision-recall-gain docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
4. When you're done making changes run all the checks and docs builder with `tox <https://tox.wiki/en>`_ one command::
